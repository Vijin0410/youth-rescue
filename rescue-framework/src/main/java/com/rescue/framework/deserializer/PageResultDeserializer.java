package com.rescue.framework.deserializer;
...
public class PageResultDeserializer extends StdDeserializer<PageResult> {
  ...
  public PageResult deserialize(JsonParser p, DeserializationContext ctxt)
    ...
    PageResult.Data data = om.readValue(s, PageResult.Data.class);

    PageResult pageResult = new PageResult();
    pageResult.setData(data);
    pageResult.setCode(Result.success().getCode());
    pageResult.setMsg(Result.success().getMsg());

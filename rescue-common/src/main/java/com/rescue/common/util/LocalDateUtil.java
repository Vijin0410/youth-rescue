...
public class LocalDateUtil {
    ...
    public static String  getStartTimeStr(LocalDate localDate){
        return formatter.format(LocalDateTime.of(localDate,startTime));
    }
    ...
    public static String  getEndTimeStr(LocalDate localDate){
        return formatter.format(LocalDateTime.of(localDate,endTime));
    }
    ...
    public static boolean isWithinRange(LocalDate currentDate, LocalDate startDate, LocalDate endDate) {
        if(Objects.isNull(currentDate) || Objects.isNull(startDate) || Objects.isNull(endDate)){
            return false;
        }
